...
public class FormularioEntradaAtendente extends JFrame {

	private JPanel contentPane;
	private JTextField textField;
	private JPasswordField passwordField;

	public FormularioEntradaAtendente() {
		...
		btnEntrar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if((textField.getText().equals(String.valueOf(Atendente.dadosAtendente.get(indice).getLoginAtendente())) && (passwordField.getText().equals(String.valueOf(Atendente.dadosAtendente.get(indice).getSenhaAtendente()))))) {
						
					//Chamar formulario
					FormularioAtendente ft = new FormularioAtendente();
					ft.repaint();
